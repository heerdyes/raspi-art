...
void exit() {
  ...
  // comment below line if roland boutique d-05 connected; seems like some expr pedal glitch
  //if(myBus!=null){ myBus.sendControllerChange(0, 11, 127); }
  println("[exit] restored expression pedal level to maximum");
  // stop loop
  if(looptask!=null){ looptask.stoploop(); }
