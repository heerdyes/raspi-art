...
void toprightstats(PGraphics g, int genlim, float p1, float p2) {
  float cornerx=g.width-450;
  g.text("PARAM1 = "+nf(p1, 3, 3), cornerx, 10);
  g.text("PARAM2 = "+nf(p2, 3, 3), cornerx, 60);
